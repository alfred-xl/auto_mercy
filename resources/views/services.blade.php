...
>
    <section class="bg-pearl py-section-compact sm:py-section">
        <div class="mx-auto grid max-w-wide items-center gap-12 px-gutter lg:grid-cols-[0.95fr_1.05fr] lg:gap-20 xl:gap-28">
            ...
            <div class="relative overflow-hidden rounded-[1.5rem] bg-carbon shadow-overlay">
    ...
    <section class="bg-pure-white py-section" aria-labelledby="services-heading">
        <div class="mx-auto max-w-site px-gutter">
            <div class="grid gap-6 md:grid-cols-[1fr_0.7fr] md:items-end">
                <div class="max-w-2xl">
            ...
            <div class="mt-12 grid gap-5 lg:grid-cols-2">
                <article class="flex min-h-[24rem] flex-col rounded-card bg-carbon p-7 text-pure-white sm:p-9 lg:row-span-2">
                ...
                <article class="rounded-card border border-border-default bg-pearl p-7 sm:p-8">
                ...
                <article class="rounded-card border border-border-default bg-pearl p-7 sm:p-8 lg:col-start-1">
                    <span class="inline-flex h-10 w-10 items-center justify-center rounded-button bg-pure-white text-carbon">
